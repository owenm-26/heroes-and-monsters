...
public class TextDataLoader {
    ...
    private static File getDataSubDirectory(String directory){
        ...
        File folder = new File(base + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator + "Common" + File.separator + "Data" + File.separator + directory);
        return folder;
    }
